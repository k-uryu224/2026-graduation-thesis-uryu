...
% ここを書き換えてください
\title{VLMを用いた長期ロボットタスクにおける工程文脈依存的不確実性診断}
\etitle{Process-Context-Dependent Uncertainty Diagnosis for Long-Horizon Robot Tasks Using Vision-Language Models}
\author{瓜生 滉宜}
\date{2027年2月}
