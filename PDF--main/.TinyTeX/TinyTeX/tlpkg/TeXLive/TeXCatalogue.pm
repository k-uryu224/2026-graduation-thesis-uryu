# $Id: TeXCatalogue.pm 79178 2026-05-27 16:36:49Z karl $
...
sub initialize {
  ...
  #warn "$id: got topics:", join (" ", keys %topics), "\n";
  push @{$self->{'topic'}}, sort(keys %topics);
  #warn "$id:   sorted into: @{$self->{'topic'}}\n";
}
